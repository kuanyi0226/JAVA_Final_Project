...
// 		});
	...
	public void paint(Graphics g) {
	    ...
	    if(isComplete) {
	    	if(!isFail) {
	    		GameImage.drawWord(g, "Good Job~ You Spend : " + elapsedSeconds + " sec", Color.WHITE, 40,200, 300);
	    		GameImage.drawWord(g, "look at the masterpiece", Color.WHITE, 40,260, 400);
	    	}else {
...
//Time
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(isStart && !isOverlap ) {
			...
			if(length == 0 || elapsedSeconds >= 150) {
				isFail = true;
				isComplete = true;
			}
